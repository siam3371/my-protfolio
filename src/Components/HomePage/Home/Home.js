...
import Footer from '../../Footer/Footer';
 ...
 return (
        ...
        steps={[ 'Hi, I am Siam', 1000, 'I am Web Developer ', 500 ]}
        loop={Infinity}
        wrapper="p"
      /></h2>
                 </div>
                     <div className="col-lg-6  col-12 col-md-6 ">
                        ...
                        <button className="button-81 m-3" role="button"><a href="https://docs.google.com/document/d/1HOk9YmUEpim_5iDswbZvzwNF-7dhvLZ9nYuatzYD5TI/edit?usp=sharing" className="text-decoration-none">Linkedin </a></button>
                    </div>
            </div>
           <Projects></Projects>
           <About></About>
